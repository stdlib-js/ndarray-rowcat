...
```javascript
rowcat = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-rowcat@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var rowcat = require( 'path/to/vendor/umd/ndarray-rowcat/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-rowcat@umd/browser.js"></script>
```
